...
export function registerSyncRoutes(app, pool, extractUser, requireUser) {
  ...
  ;(async () => {
    ...
    await runMigration('melissa-lower-body-template', async () => {
      // Programme template "Melissa — Bas du corps" : débutante, haltères + machines simples, 3j/sem, 12 sem.
      const MEL = 'tpl-mel'
      const melRecords = [
        // Programme
        { store: 'programs', id: `${MEL}-prog`, data: { id: `${MEL}-prog`, name: 'Melissa — Bas du corps', goal: 'hypertrophy', level: 'beginner', durationWeeks: 12, sessionsPerWeek: 3, color: '#a855f7', isTemplate: true, isActive: false, weekTemplate: { monday: `${MEL}-j1`, wednesday: `${MEL}-j2`, friday: `${MEL}-j3` }, createdAt: 1, updatedAt: now, deleted: false, dirty: true } },
        // Séances
        { store: 'workoutTemplates', id: `${MEL}-j1`, data: { id: `${MEL}-j1`, programId: `${MEL}-prog`, name: 'J1 · Fessiers & Adducteurs', type: 'lower', muscleGroups: ['glutes', 'hamstrings', 'quads'], updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutTemplates', id: `${MEL}-j2`, data: { id: `${MEL}-j2`, programId: `${MEL}-prog`, name: 'J2 · Ischio-jambiers & Dos', type: 'lower', muscleGroups: ['hamstrings', 'quads', 'back_thickness'], updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutTemplates', id: `${MEL}-j3`, data: { id: `${MEL}-j3`, programId: `${MEL}-prog`, name: 'J3 · Fessiers & Dos', type: 'lower', muscleGroups: ['glutes', 'hamstrings', 'back_thickness', 'core'], updatedAt: now, deleted: false, dirty: true } },
        // ── J1 WETs ──────────────────────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-01`, data: { id: `${MEL}-j1-01`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-glute-bridge',         order: 1,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-02`, data: { id: `${MEL}-j1-02`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-bodyweight-squat',     order: 2,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-03`, data: { id: `${MEL}-j1-03`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-walking-lunges',       order: 3,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-04`, data: { id: `${MEL}-j1-04`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-hip-9090',             order: 4,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 10, autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-05`, data: { id: `${MEL}-j1-05`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-hip-thrust-bw',        order: 5,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 60,                  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-06`, data: { id: `${MEL}-j1-06`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-squat-barbell',        order: 6,  targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 90, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-07`, data: { id: `${MEL}-j1-07`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-leg-curl-lying',       order: 7,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 60, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-08`, data: { id: `${MEL}-j1-08`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-hip-adduction-machine',order: 8,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 60, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-09`, data: { id: `${MEL}-j1-09`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-bulgarian-split-squat',order: 9,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 10, autoProgress: true,  progressStepKg: 1, restSec: 75, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j1-10`, data: { id: `${MEL}-j1-10`, workoutTemplateId: `${MEL}-j1`, exerciseId: 'seed-plank',               order: 10, targetSets: 3, repsMode: 'fixed', targetRepsMin: 1,  targetDurationSec: 45, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J2 WETs ──────────────────────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-01`, data: { id: `${MEL}-j2-01`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-glute-bridge',         order: 1,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-02`, data: { id: `${MEL}-j2-02`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-bodyweight-squat',     order: 2,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-03`, data: { id: `${MEL}-j2-03`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-walking-lunges',       order: 3,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-04`, data: { id: `${MEL}-j2-04`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-romanian-deadlift',    order: 4,  targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 90, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-05`, data: { id: `${MEL}-j2-05`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-leg-press',            order: 5,  targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 90, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-06`, data: { id: `${MEL}-j2-06`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-row-dumbbell',         order: 6,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-07`, data: { id: `${MEL}-j2-07`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-leg-extension',        order: 7,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 60, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-08`, data: { id: `${MEL}-j2-08`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-crunch',               order: 8,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j2-09`, data: { id: `${MEL}-j2-09`, workoutTemplateId: `${MEL}-j2`, exerciseId: 'seed-dead-bug',             order: 9,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 8,  autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J3 WETs ──────────────────────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-01`, data: { id: `${MEL}-j3-01`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-glute-bridge',         order: 1,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-02`, data: { id: `${MEL}-j3-02`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-hip-9090',             order: 2,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 10, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-03`, data: { id: `${MEL}-j3-03`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-walking-lunges',       order: 3,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-04`, data: { id: `${MEL}-j3-04`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-hip-thrust',           order: 4,  targetSets: 3, repsMode: 'range', targetRepsMin: 8,  targetRepsMax: 10, autoProgress: true,  progressStepKg: 1, restSec: 90,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-05`, data: { id: `${MEL}-j3-05`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-deadlift',             order: 5,  targetSets: 3, repsMode: 'range', targetRepsMin: 6,  targetRepsMax: 8,  autoProgress: true,  progressStepKg: 1, restSec: 120, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-06`, data: { id: `${MEL}-j3-06`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-bulgarian-split-squat',order: 6,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 8,  autoProgress: true,  progressStepKg: 1, restSec: 90,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-07`, data: { id: `${MEL}-j3-07`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-row-dumbbell',         order: 7,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 75,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-08`, data: { id: `${MEL}-j3-08`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-leg-curl-seated',      order: 8,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 60,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${MEL}-j3-09`, data: { id: `${MEL}-j3-09`, workoutTemplateId: `${MEL}-j3`, exerciseId: 'seed-side-plank',           order: 9,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 1,  targetDurationSec: 25, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
      ]
      for (const r of melRecords) {
        await pool.query(
          `INSERT INTO sync_records (user_id, store, id, data, updated_at)
           VALUES ($1, $2, $3, $4::jsonb, $5)
           ON CONFLICT (user_id, store, id) DO NOTHING`,
          [ADMIN_USER_ID, r.store, r.id, JSON.stringify(r.data), now],
        )
      }
    })

    await runMigration('upper-complet-template', async () => {
      // Programme template "Upper Complet" : haltères + machines, 3j/sem, 13 sem, intermédiaire.
      // 3 séances plein corps (2 SS haut + 2 SS bas), ~42-45 min. J3 allégé (veille football).
      const UP = 'tpl-up'
      const upRecords = [
        // Programme
        { store: 'programs', id: `${UP}-prog`, data: { id: `${UP}-prog`, name: 'Upper Complet', goal: 'hypertrophy', level: 'intermediate', durationWeeks: 13, sessionsPerWeek: 3, color: '#3b82f6', isTemplate: true, isActive: false, weekTemplate: { monday: `${UP}-j1`, wednesday: `${UP}-j2`, friday: `${UP}-j3` }, createdAt: 1, updatedAt: now, deleted: false, dirty: true } },
        // Séances
        { store: 'workoutTemplates', id: `${UP}-j1`, data: { id: `${UP}-j1`, programId: `${UP}-prog`, name: 'J1 · Push-Pull & Legs A',      type: 'fullbody', muscleGroups: ['chest', 'back_thickness', 'shoulders', 'triceps', 'quads', 'hamstrings'],                updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutTemplates', id: `${UP}-j2`, data: { id: `${UP}-j2`, programId: `${UP}-prog`, name: 'J2 · Pull & Legs B',           type: 'fullbody', muscleGroups: ['back_width', 'back_thickness', 'biceps', 'hamstrings', 'quads'],                        updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutTemplates', id: `${UP}-j3`, data: { id: `${UP}-j3`, programId: `${UP}-prog`, name: 'J3 · Upper Pump & Legs léger', type: 'fullbody', muscleGroups: ['chest_upper', 'back_width', 'shoulders_lateral', 'biceps', 'glutes', 'hamstrings'],    updatedAt: now, deleted: false, dirty: true } },
        // ── J1 WETs — échauffement ───────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-01`, data: { id: `${UP}-j1-01`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-shoulder-circles',  order: 1,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-02`, data: { id: `${UP}-j1-02`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-jumping-jacks',     order: 2,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 30, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-03`, data: { id: `${UP}-j1-03`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-mountain-climbers', order: 3,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-04`, data: { id: `${UP}-j1-04`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-superman',          order: 4,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-05`, data: { id: `${UP}-j1-05`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-bodyweight-squat',  order: 5,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true,  updatedAt: now, deleted: false, dirty: true } },
        // ── J1 WETs — entraînement ───────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-06`, data: { id: `${UP}-j1-06`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-bench-dumbbell',           order: 6,  targetSets: 4, repsMode: 'range', targetRepsMin: 8,  targetRepsMax: 10, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-07`, data: { id: `${UP}-j1-07`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-row-dumbbell',             order: 7,  targetSets: 4, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 90, supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-08`, data: { id: `${UP}-j1-08`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-shoulder-press-dumbbell',  order: 8,  targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-09`, data: { id: `${UP}-j1-09`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-triceps-overhead',         order: 9,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-10`, data: { id: `${UP}-j1-10`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-bulgarian-split-squat', order: 10, targetSets: 3, repsMode: 'fixed', targetRepsMin: 10, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-11`, data: { id: `${UP}-j1-11`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-hip-thrust-bw',            order: 11, targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 75, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-12`, data: { id: `${UP}-j1-12`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-leg-extension',            order: 12, targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-13`, data: { id: `${UP}-j1-13`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-leg-curl-lying',           order: 13, targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 60, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-14`, data: { id: `${UP}-j1-14`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-plank',                    order: 14, targetSets: 3, repsMode: 'fixed', targetRepsMin: 1,  targetDurationSec: 45, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J2 WETs — échauffement ───────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-01`, data: { id: `${UP}-j2-01`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-shoulder-circles',  order: 1,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-02`, data: { id: `${UP}-j2-02`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-jumping-jacks',     order: 2,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 30, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-03`, data: { id: `${UP}-j2-03`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-mountain-climbers', order: 3,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-04`, data: { id: `${UP}-j2-04`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-glute-bridge',      order: 4,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-05`, data: { id: `${UP}-j2-05`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-hip-9090',          order: 5,  targetSets: 1, repsMode: 'fixed', targetRepsMin: 10, autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J2 WETs — entraînement ───────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-06`, data: { id: `${UP}-j2-06`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-pullover',             order: 6,  targetSets: 4, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-07`, data: { id: `${UP}-j2-07`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-row-dumbbell',         order: 7,  targetSets: 4, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 90, supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-08`, data: { id: `${UP}-j2-08`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-rear-delt-fly',        order: 8,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-09`, data: { id: `${UP}-j2-09`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-curl-dumbbell',        order: 9,  targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-10`, data: { id: `${UP}-j2-10`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-romanian-deadlift',     order: 10, targetSets: 3, repsMode: 'range', targetRepsMin: 10, targetRepsMax: 12, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-11`, data: { id: `${UP}-j2-11`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-bulgarian-split-squat', order: 11, targetSets: 3, repsMode: 'fixed', targetRepsMin: 10, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-12`, data: { id: `${UP}-j2-12`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-leg-curl-seated',       order: 12, targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-13`, data: { id: `${UP}-j2-13`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-leg-extension',         order: 13, targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-14`, data: { id: `${UP}-j2-14`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-side-plank',           order: 14, targetSets: 3, repsMode: 'fixed', targetRepsMin: 1,  targetDurationSec: 30, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-15`, data: { id: `${UP}-j2-15`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-bicycle-crunch',       order: 15, targetSets: 3, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J3 WETs — échauffement (court) ──────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-01`, data: { id: `${UP}-j3-01`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-shoulder-circles',  order: 1, targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-02`, data: { id: `${UP}-j3-02`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-jumping-jacks',     order: 2, targetSets: 1, repsMode: 'fixed', targetRepsMin: 30, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-03`, data: { id: `${UP}-j3-03`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-mountain-climbers', order: 3, targetSets: 1, repsMode: 'fixed', targetRepsMin: 20, autoProgress: false, progressStepKg: 0, restSec: 20, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-04`, data: { id: `${UP}-j3-04`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-inchworm',          order: 4, targetSets: 1, repsMode: 'fixed', targetRepsMin: 8,  autoProgress: false, progressStepKg: 0, restSec: 30, isWarmup: true, updatedAt: now, deleted: false, dirty: true } },
        // ── J3 WETs — entraînement ───────────────────────────────────────────
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-05`, data: { id: `${UP}-j3-05`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-incline-bench-dumbbell', order: 5,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-06`, data: { id: `${UP}-j3-06`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-pullover',               order: 6,  targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'A', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-07`, data: { id: `${UP}-j3-07`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-lateral-raise',          order: 7,  targetSets: 3, repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-08`, data: { id: `${UP}-j3-08`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-curl-hammer',            order: 8,  targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 60, supersetGroup: 'B', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-09`, data: { id: `${UP}-j3-09`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-hip-thrust-bw',  order: 9,  targetSets: 3, repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: false, progressStepKg: 0, restSec: 0,  supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-10`, data: { id: `${UP}-j3-10`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-walking-lunges', order: 10, targetSets: 3, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 60, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-11`, data: { id: `${UP}-j3-11`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-leg-extension',  order: 11, targetSets: 3, repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: true,  progressStepKg: 1, restSec: 0,  supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-12`, data: { id: `${UP}-j3-12`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-leg-curl-lying', order: 12, targetSets: 3, repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: true,  progressStepKg: 1, restSec: 60, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-13`, data: { id: `${UP}-j3-13`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-dead-bug',               order: 13, targetSets: 3, repsMode: 'fixed', targetRepsMin: 8,  autoProgress: false, progressStepKg: 0, restSec: 30, isAb: true, updatedAt: now, deleted: false, dirty: true } },
      ]
    ...
    await runMigration('upper-complet-template-v2-leg-pairs', async () => {
      // Correction des paires bas du corps : regroupement logique (composés ensemble,
      // machines isolation ensemble car côte à côte en salle).
      // J1 : j1-11 leg-curl-lying→hip-thrust-bw (SS C) / j1-13 hip-thrust-bw→leg-curl-lying (SS D)
      // J2 : j2-11 leg-extension→squat-bulgare (SS C) / j2-13 squat-bulgare→leg-extension (SS D)
      // J3 : j3-10 leg-curl-lying→walking-lunges (SS C) / j3-12 walking-lunges→leg-curl-lying (SS D)
      const UP = 'tpl-up'
      const patches = [
        { id: `${UP}-j1-11`, data: { exerciseId: 'seed-hip-thrust-bw',            repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0 } },
        { id: `${UP}-j1-13`, data: { exerciseId: 'seed-leg-curl-lying',            repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1 } },
        { id: `${UP}-j2-11`, data: { exerciseId: 'seed-bulgarian-split-squat',     repsMode: 'fixed', targetRepsMin: 10, autoProgress: true,  progressStepKg: 1,  restSec: 75 } },
        { id: `${UP}-j2-13`, data: { exerciseId: 'seed-leg-extension',             repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1,  restSec: 75 } },
        { id: `${UP}-j3-10`, data: { exerciseId: 'seed-walking-lunges',            repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0 } },
        { id: `${UP}-j3-12`, data: { exerciseId: 'seed-leg-curl-lying',            repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: true,  progressStepKg: 1 } },
      ]
      for (const p of patches) {
        await pool.query(
          `UPDATE sync_records
              SET data = data || $1::jsonb,
                  updated_at = $2
            WHERE user_id = $3 AND store = 'workoutExerciseTemplates' AND id = $4`,
          [JSON.stringify({ ...p.data, updatedAt: now, dirty: true }), now, ADMIN_USER_ID, p.id],
        )
      }
    })
