  ...
  ;(async () => {
    ...
    await runMigration('upper-complet-template', async () => {
      ...
      const upRecords = [
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-11`, data: { id: `${UP}-j1-11`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-leg-curl-lying',           order: 11, targetSets: 3, repsMode: 'range', targetRepsMin: 12, targetRepsMax: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j1-13`, data: { id: `${UP}-j1-13`, workoutTemplateId: `${UP}-j1`, exerciseId: 'seed-hip-thrust-bw',            order: 13, targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: false, progressStepKg: 0, restSec: 60, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-11`, data: { id: `${UP}-j2-11`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-leg-extension',        order: 11, targetSets: 3, repsMode: 'fixed', targetRepsMin: 15, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j2-13`, data: { id: `${UP}-j2-13`, workoutTemplateId: `${UP}-j2`, exerciseId: 'seed-bulgarian-split-squat', order: 13, targetSets: 3, repsMode: 'fixed', targetRepsMin: 10, autoProgress: true,  progressStepKg: 1, restSec: 75, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-10`, data: { id: `${UP}-j3-10`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-leg-curl-lying',         order: 10, targetSets: 3, repsMode: 'range', targetRepsMin: 15, targetRepsMax: 20, autoProgress: true,  progressStepKg: 1, restSec: 60, supersetGroup: 'C', updatedAt: now, deleted: false, dirty: true } },
        ...
        { store: 'workoutExerciseTemplates', id: `${UP}-j3-12`, data: { id: `${UP}-j3-12`, workoutTemplateId: `${UP}-j3`, exerciseId: 'seed-walking-lunges',         order: 12, targetSets: 3, repsMode: 'fixed', targetRepsMin: 12, autoProgress: false, progressStepKg: 0, restSec: 60, supersetGroup: 'D', updatedAt: now, deleted: false, dirty: true } },
